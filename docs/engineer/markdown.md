...
在撰写文档的时候如果能遵循一点良好的规范，将能提升所有人的阅读体验。
...
- 1.1.【强制】中英文之间需要增加空格
   ...
   ```md
    ...
    HTML定义网页的结构与内容，CSS定义其格式与样式，而 JavaScript则为网页增加可交互性，创作功能丰富的Web应用。
...
1. markdownlint：和其他lint工具一样 标识错误。
2. markdown preview enhanced：实时预览md文件。
